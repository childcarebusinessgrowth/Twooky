...
const config = getProviderTypePageConfig("afterschool_program")
...
interface AfterschoolProgramsSearchPageProps {
  searchParams?: Promise<SearchPageQueryParams>
}

export default async function AfterschoolProgramsSearchPage({
  searchParams,
}: AfterschoolProgramsSearchPageProps) {
