...
export function createProviderPinDataUri(): string {
  const svg = `
    <svg width="56" height="72" viewBox="0 0 56 72" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g filter="url(#shadow)">
        <path d="M28 60C28 60 46 42.8 46 30C46 19.5066 37.4934 11 27 11C16.5066 11 8 19.5066 8 30C8 42.8 28 60 28 60Z" fill="#0ba5aa"/>
        <path d="M28 60C28 60 46 42.8 46 30C46 19.5066 37.4934 11 27 11C16.5066 11 8 19.5066 8 30C8 42.8 28 60 28 60Z" stroke="#087a7e" stroke-width="2"/>
      </g>
      ...
      <path d="M23.8 33.5V29.5H27.2V33.5H23.8Z" fill="#0ba5aa"/>
      <rect x="28.6" y="28.7" width="2.2" height="2.2" rx="0.5" fill="#00d4ff"/>
      <path d="M19.2 27.9L27 22.4L34.8 27.9" stroke="#0ba5aa" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  `.trim()
