(function () {
  ...
  if (!document.getElementById(stylesId)) {
    ...
    styleEl.id = stylesId
    styleEl.textContent =
      ".twooki-spw{position:fixed;left:20px;bottom:20px;z-index:2147483000;width:min(520px,calc(100vw - 32px));background:#fff;color:#1f2937;border:1px solid rgba(32,62,104,.24);border-radius:18px;box-shadow:0 18px 45px rgba(2,6,23,.24);padding:12px;transform:translateY(120%);opacity:0;transition:transform .28s ease,opacity .28s ease;font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,sans-serif;cursor:pointer}.twooki-spw.twooki-spw-show{transform:translateY(0);opacity:1}.twooki-spw-card{position:relative;display:flex;gap:12px;align-items:flex-start}.twooki-spw-close{position:absolute;top:-6px;right:-4px;width:28px;height:28px;border-radius:999px;border:1px solid #e5e7eb;background:#fff;color:#6b7280;font-size:18px;line-height:1;cursor:pointer}.twooki-spw-close:hover{color:#111827}.twooki-spw-avatar-wrap{width:106px;height:106px;flex:none;border-radius:13px;overflow:hidden;background:#e5e7eb}.twooki-spw-avatar,.twooki-spw-avatar-video{width:100%;height:100%;display:block;object-fit:cover}.twooki-spw-avatar-video{background:#000}.twooki-spw-content{min-width:0;flex:1;padding-right:18px}.twooki-spw-stars{display:flex;gap:2px;color:#F9BB11;font-size:30px;line-height:1;margin-bottom:6px}.twooki-spw-text{color:#111827;line-height:1.35;font-size:17px;display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden}.twooki-spw-author{margin-top:7px;font-size:14px;color:#6b7280;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.twooki-spw-footer{margin-top:10px;display:flex;justify-content:flex-end}.twooki-spw-verified{font-size:12px;color:#203e68;background:#F9BB11;border:1px solid #E7D59A;border-radius:999px;padding:4px 10px;font-weight:700}.twooki-spw-modal-backdrop{position:fixed;inset:0;z-index:2147483001;background:rgba(15,23,42,.58);display:none;align-items:center;justify-content:center;padding:20px}.twooki-spw-modal-backdrop.twooki-spw-modal-show{display:flex}.twooki-spw-modal{position:relative;width:min(510px,calc(100vw - 40px));max-height:calc(100vh - 40px);overflow:auto;background:#fff;border-radius:14px;border:1px solid rgba(15,23,42,.12);box-shadow:0 24px 70px rgba(2,6,23,.45)}.twooki-spw-modal-close{position:absolute;top:10px;right:12px;border:0;background:transparent;color:#6b7280;font-size:34px;line-height:1;cursor:pointer;z-index:3}.twooki-spw-modal-close:hover{color:#111827}.twooki-spw-modal-body{padding:18px 24px 22px}.twooki-spw-modal-title{font-size:18px;line-height:1.3;color:#111827;font-weight:700}.twooki-spw-modal-author{font-size:14px;color:#64748b;margin-top:3px}.twooki-spw-modal-stars{display:flex;gap:2px;color:#F9BB11;font-size:34px;line-height:1;margin:10px 0 8px}.twooki-spw-modal-feature-media{margin:14px 0 12px}.twooki-spw-modal-feature-video,.twooki-spw-modal-feature-image{width:100%;max-height:320px;border-radius:10px;display:block}.twooki-spw-modal-feature-video{background:#000}.twooki-spw-modal-feature-image{object-fit:cover;background:#e5e7eb}.twooki-spw-modal-text{font-size:16px;line-height:1.56;color:#374151}.twooki-spw-modal-row{margin-top:16px;display:flex;justify-content:flex-end}.twooki-spw-modal-verified{border:0;background:#F9BB11;color:#203e68;padding:11px 16px;border-radius:10px;font-size:14px;font-weight:700;cursor:pointer}.twooki-spw-modal-verified:hover{background:#e2a907}@media (max-width:640px){.twooki-spw-avatar-wrap{width:84px;height:84px}.twooki-spw-content{padding-right:10px}.twooki-spw-stars{font-size:25px}.twooki-spw-text{font-size:15px}.twooki-spw-modal-body{padding:14px 16px 18px}}"
